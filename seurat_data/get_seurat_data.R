...
data_path <- '/Users/zhongyuanke/data/seurat_data/panc_8/celseq_data_norm.csv'
...
data_path <- '/Users/zhongyuanke/data/seurat_data/panc_8/celseq2_data_norm.csv'
...
data_path <- '/Users/zhongyuanke/data/seurat_data/panc_8/smartseq2_data_norm.csv'
...
data_path <- '/Users/zhongyuanke/data/seurat_data/panc_8/fluidigmc1_data_norm.csv'
...
data_path <- '/Users/zhongyuanke/data/seurat_data/panc_8/indrop_data_norm.csv'
# write.csv(smartseq2_celltype, celltype_path)
